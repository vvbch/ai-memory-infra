...
| Eval design | ⚠️ ADR 007 designed; `src/eval/` stubs — Phase 7 |
...
| Safety / guardrails | ⚠️ ADR 009 target; HTTPS + basic auth live; PII filter/eval not built |
| Computer-use deployment | ✅ Terraform IaC, Docker, CI on PRs, production VPS (CD manual) |
| Production observability | ⚠️ ADR 008 designed; Prometheus/Grafana Phase 8 (not in compose) |
